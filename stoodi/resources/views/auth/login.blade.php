        ...
        <div class="card shadow-lg p-3 mb-5 mt-5  rounded"  style="width: 25rem; margin-left:auto; margin-right:auto; border-radius: 3%;background-color:teal">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row" style="color:honeydew">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="remember" style="color:honeydew">
                                        {{ __('Remember Me') }}
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group row mb-0 ">
                            <div class="col-md-8 offset-md-4" >
                                ...
                                <a type="button" href="{{ '/' }}" class="btn btn-danger" style="background-color:indigo;color:white">
                                   Back
                                </a>
