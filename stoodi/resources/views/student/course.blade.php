...
<div style="position: relative">
    ...
    <h5 style="position: absolute; top: 230px; left: 30px; width: 60%; font-family: serif; font-style: oblique; color: white">"Rheza Dewantara"</h5>
    <h3 style="position: absolute; top: 140px; left: 30px; color: white">IPA 3C</h3>
    <h1 style="position: absolute; top: 175px; left: 30px; color: white">Matematika Bilingual Kelas 3 Semester 1</h1>
</div>
